...
export default function Navbar() {
  ...
  const navItems = [
    { nameDesktop: 'Home', nameMobile: 'Beranda', href: '/home', icon: 'home' },
    { nameDesktop: 'Anggota', nameMobile: 'Anggota', href: '/anggota', icon: 'group' },
    { nameDesktop: 'Events', nameMobile: 'Event', href: '/event', icon: 'event' },
    { nameDesktop: 'Aspirasi', nameMobile: 'Aspirasi', href: '/aspirasi', icon: 'campaign' },
    { nameDesktop: 'Akun', nameMobile: 'Profil', href: '/profile', icon: 'account_circle' },
  ];
