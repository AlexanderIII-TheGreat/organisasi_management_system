...
class UserResource extends JsonResource
{
    ...
    public function toArray(Request $request): array
    {
        return [
            ...
            'remaining_days' => $this->expires_at ? (int) now()->startOfDay()->diffInDays($this->expires_at->startOfDay(), false) : null,
            'renewal_requested_at' => $this->renewal_requested_at?->toISOString(),
